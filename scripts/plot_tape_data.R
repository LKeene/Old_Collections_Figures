# This script takes raw tapestation data and makes a representation of the raw 
# tapestation traces using representative RNA lengths from each experimentally 
# dried fly timepoint.
...
rna_time_3 <- read.electrophoresis("tapestation/2023-03-24 - 13-19-06-HSRNA.xml")
...
df4 <- filter(.data = df4, sample.index == 4)
...
df4["sample.index"][df4["sample.index"] == 4] <- 11
