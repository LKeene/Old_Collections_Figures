...
other_viruses <- other_viruses %>% 
  ...
  mutate(virus_name = as.factor(fct_rev(virus_name)),
         id = factor(id, levels = c("Illinois 1908 1", "Illinois 1915 1", 
                                     "Illinois 1915 2", "Minnesota 1919 1", 
                                     "New York 1927 1", "Illinois 1930 1",
                                     "Illinois 1942 1", "Hawai'i 1953 1", 
                                     "Hawai'i 1954 1", "Pennsylvania 1963 1",
                                     "California 2000 1", "California 2000 2",
                                     "North Carolina 2006 1", "North Carolina 2006 2",
                                     "Ontario, CAN 2010 1", "California 2011 1")))
